...
def split_data(df):
    train_substrates, test_substrates = train_test_split(
        np.unique(df["substrateName"].values),
        test_size=0.3,
        shuffle=True,
        random_state=42,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rootPath",
        type=str,
        default="/home/s522r/Desktop/perovskite/new_data/2021_KIT_PerovskiteDeposition",
    )
