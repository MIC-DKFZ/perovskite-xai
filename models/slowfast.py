...
class SlowFast(BaseModel):
    def __init__(self, num_classes, hypparams):
        ...
        self.model = create_slowfast(
            ...
            slowfast_fusion_conv_stride=(
                6,
                1,
                1,
            ),  # nb of frames_slow divided by slowfast_fusion_conv_stride[0] has to be nb of frames fast
            head_pool_kernel_sizes=(
                (6, 2, 2),
                (36, 2, 2),
            ),  # head_pool_kernel_sizes[0,0]*slowfast_fusion_conv_stride[0] = head_pool_kernel_sizes[1,0]
