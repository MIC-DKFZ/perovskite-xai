...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, stochastic_depth=0.0, apply_se=False, p_shakedrop=None, dims=2):
...
class ResNet(BaseModel):
    ...
    def _make_layer(self, block, planes, num_blocks, stride):
        ...
        for stride in strides:
            ...
            layers.append(block(self.in_planes, planes, stride, self.stochastic_depth, self.se,
                                self.ps_shakedrop[self.u_idx], self.dims))
