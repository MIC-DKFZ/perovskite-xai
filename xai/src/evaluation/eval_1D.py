...
fig = make_subplots(
    ...
    subplot_titles=(
        ...
        format_title("Robustness", "Infidelity " + "\u2198",),
        format_title("", "Sensitivity " + "\u2198",),
    ),
)
...
fig.add_trace(
    go.Box(y=sens_1D[0].squeeze(), name="EG", marker_color="#042940"), row=1, col=5,
)
fig.add_trace(
    go.Box(y=sens_1D[1].squeeze(), name="IG", marker_color="#005C53"), row=1, col=5,
)
fig.add_trace(
    go.Box(y=sens_1D[2].squeeze(), name="GBC", marker_color="#9FC131"), row=1, col=5,
)
fig.add_trace(
    go.Box(y=sens_1D[3].squeeze(), name="GGC", marker_color="#DBF227"), row=1, col=5,
)
...
fig.update_yaxes(rangemode="tozero", range=[0, 50], row=1, col=5)
